 ...
 */
public class EquiDepthHistogramTrivial {
    ...
    /**
     * Constructor of the EquiDepthHistogramTrivial. As it is not possible to create this kind of histogram in one pass
     ...
     */
    public EquiDepthHistogramTrivial(TreeMap<Integer, Integer> sortedInput, int numBuckets, int total) {
