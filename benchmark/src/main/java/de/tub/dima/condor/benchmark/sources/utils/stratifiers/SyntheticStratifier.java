...
public class SyntheticStratifier extends RichMapFunction<Tuple3<Integer, Integer, Long>, Tuple2<Integer, Integer>> {

    private int stratification;
    private double factor;

    public SyntheticStratifier(int stratification) {
        this.stratification = stratification;
        this.factor = 1000/stratification;
    }
