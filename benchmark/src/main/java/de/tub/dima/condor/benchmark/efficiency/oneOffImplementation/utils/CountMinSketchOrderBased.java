 ...
 */
public class CountMinSketchOrderBased<T> extends StratifiedSynopsis implements Synopsis<T>, Serializable {
...
//    private HashSet<T> Elements;
     ...
     */
    public CountMinSketchOrderBased(Integer width, Integer height, Long seed) {
        this.width = width;
        this.height = height;
        this.seed = seed;
