 ...
 */
public class YahooHLLOnCondorStratified {
	public static void run(int parallelism, long runtime, int targetThroughput) throws Exception {
		...
		Class<HLLYahoo> synopsisClass = HLLYahoo.class;
		Window[] windows = {new TumblingWindow(WindowMeasure.Time, runtime)};
		Object[] synopsisParameters = new Object[]{};
		...
		// Build the synopses
		SingleOutputStreamOperator<StratifiedSynopsisWrapper<Integer, WindowedSynopsis<HLLYahoo>>> synopsesStream = SynopsisBuilder.buildStratified(config);
