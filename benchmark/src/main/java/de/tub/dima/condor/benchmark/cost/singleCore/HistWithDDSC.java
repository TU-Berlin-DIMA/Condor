...
public class HistWithDDSC {
    public static void run(String outputDir, String uniformTimestampedFilePath) throws Exception {
        ...
        try {
            ...
            PrintWriter out = new PrintWriter(new FileOutputStream(new File(outputDir + "/HistogramWithDDSketch-single-core.txt"), true), true);
            String line;
            ...
            out.append("\nSource: Uniform, Histogram with DD-Sketch Synopsis: ");
            out.append("\n" + result);
