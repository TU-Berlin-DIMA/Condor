...
public class SamplerReservoirSC {
    public static void run(String outputDir, String uniformTimestampedFilePath) throws Exception {
        ...
        try {
            ...
            PrintWriter out = new PrintWriter(new FileOutputStream(new File(outputDir + "/ReservoirSampler-single-core.txt"), true), true);
            String line;
            String result = "Throughput=";
            String numRecords = "";
            ReservoirSampler synopsis = new ReservoirSampler(10000);
            ...
            out.append("\nSource: Uniform, Reservoir-Sampler Synopsis: ");
            out.append("\n" + result);
