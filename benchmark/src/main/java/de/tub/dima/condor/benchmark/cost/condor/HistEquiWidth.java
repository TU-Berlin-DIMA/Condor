...
public class HistEquiWidth {
    public static void run(int parallelism, int targetThroughput, int iteration) throws Exception {
        String jobName = "Synopses COST test EquiWidth Histogram | parallelism: "+parallelism + " | iteration: "+iteration+ " | targetThroughput: " + targetThroughput;
        ...
        Object[] synopsisParameters = new Object[]{0d, 1001d, 1000}; // lower bound, upper bound, numBuckets
