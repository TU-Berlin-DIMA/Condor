...
import de.tub.dima.condor.core.synopsis.Sketches.CuckooFilter;

import java.io.*;
import java.util.zip.GZIPInputStream;

public class SketchCuckooFilterSC {
    public static void run(String outputDir, String uniformTimestampedFilePath) throws Exception {
        ...
        try {
            ...
            PrintWriter out = new PrintWriter(new FileOutputStream(new File(outputDir + "/CuckooFilter-single-core.txt"), true), true);
            String line;
            String result = "Throughput=";
            String numRecords = "";
            CuckooFilter synopsis = new CuckooFilter(50000, 64, 42l);
            ...
            out.append("\nSource: Uniform, CuckooFilter Synopsis: ");
            out.append("\n" + result);
