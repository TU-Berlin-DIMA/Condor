...
public class SketchDD {
    public static void run(int parallelism, int targetThroughput) throws Exception {
        String jobName = "DDSketch Synopses COST test " + parallelism;
        ...
        // Build the synopses
        SingleOutputStreamOperator<WindowedSynopsis<DDSketch>> synopsesStream = SynopsisBuilder.build(config);
