...
public class SamplerFiFo {
    public static void run(int parallelism, int targetThroughput) throws Exception {
        String jobName = "FiFo Sampler Synopses COST test " + parallelism;
        ...
        Class<FiFoSampler> synopsisClass = FiFoSampler.class;
        ...
        // Build the synopses
        SingleOutputStreamOperator<WindowedSynopsis<FiFoSampler>> synopsesStream = SynopsisBuilder.build(config);
