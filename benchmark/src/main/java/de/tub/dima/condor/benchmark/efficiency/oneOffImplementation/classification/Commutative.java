...
public class Commutative {
	public static void run(int parallelism, long runtime, int targetThroughput, String outputDir) throws Exception {
		String jobName = "Condor's Count Min Sketch (Commutative) - classification test "+parallelism;
		...
		Class<CountMinSketchCommutative> synopsisClass = CountMinSketchCommutative.class;
