...
public class SamplerFiFoSC {
    public static void run(String outputDir, String uniformTimestampedFilePath) throws Exception {
        ...
        try {
            ...
            PrintWriter out = new PrintWriter(new FileOutputStream(new File(outputDir + "/FiFoSampler-single-core.txt"), true), true);
            String line;
            String result = "Throughput=";
            String numRecords = "";
            FiFoSampler synopsis = new FiFoSampler(10000);
            ...
            out.append("\nSource: Uniform, FiFo-Sampler Synopsis: ");
            out.append("\n" + result);
