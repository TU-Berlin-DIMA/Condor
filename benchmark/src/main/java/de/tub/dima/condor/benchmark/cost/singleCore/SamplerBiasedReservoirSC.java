...
import de.tub.dima.condor.core.tests.BiasedReservoirSamplerTest;

import java.io.*;
import java.util.zip.GZIPInputStream;

public class SamplerBiasedReservoirSC {
    public static void run(String outputDir, String uniformTimestampedFilePath) throws Exception {
        ...
        try {
            ...
            PrintWriter out = new PrintWriter(new FileOutputStream(new File(outputDir + "/BiasedReservoirSampler-single-core.txt"), true), true);
            String line;
            String result = "Throughput=";
            String numRecords = "";
            BiasedReservoirSampler synopsis = new BiasedReservoirSampler(10000);
            ...
            for (int i = 0; i < 10; i++) {
                ...
                while (reader.ready() && (line = reader.readLine()) != null) {
                    ...
                    synopsis.update(new TimestampedElement(Integer.parseInt(tokens[0]), Long.parseLong(tokens[2])));
            ...
            out.append("\nSource: Uniform, Biased-Reservoir-Sampler Synopsis: ");
            out.append("\n" + result);
