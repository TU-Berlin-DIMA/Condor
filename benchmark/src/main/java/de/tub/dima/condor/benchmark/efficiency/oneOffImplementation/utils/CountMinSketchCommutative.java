 ...
 */
public class CountMinSketchCommutative<T> extends StratifiedSynopsis implements CommutativeSynopsis<T>, Serializable {
...
//    private HashSet<T> Elements;
     ...
     */
    public CountMinSketchCommutative(Integer width, Integer height, Long seed) {
        this.width = width;
        this.height = height;
        this.seed = seed;
...
//    }
     ...
     */
    @Override
    public CountMinSketchCommutative merge(MergeableSynopsis<T> other) {
        if (other instanceof CountMinSketchCommutative) {
            CountMinSketchCommutative otherCM = (CountMinSketchCommutative) other;
