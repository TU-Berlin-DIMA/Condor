...
public class SampleSize {
	public static void run(int parallelism, long runtime, int targetThroughput, int sampleSize) throws Exception {
		String jobName = "Condor - Sample Size efficiency test "+parallelism;
		...
		Object[] synopsisParameters = new Object[]{sampleSize};
