...
public class StratifiedCountMinSingleCore {
    public static void run(String outputDir, String uniformTimestampedPath) throws Exception {
        ...
        try {
            ...
            PrintWriter out = new PrintWriter(new FileOutputStream(new File(outputDir + "/stratified-countMin-single-core.txt"), true), true);
            String line;
