...
public class SingleCore {
    // synopsisType can be either HaarWavelet, CountMinSketch, ReservoirSampler, EquiWidthHistogram
    public static void run(String synopsisType, String outputDir, boolean stratified) throws Exception{
        ...
        try {
            ...
            if (synopsisType.equals("HaarWavelet")) {
                ...
                synopsis = getSynopsis(synopsisType);
                if(stratified){
                    ...
                    for (int i = 0; i < 10; i++) {
                        ...
                        for (int j = 0; j < 256; j++) {
                            stratifiedSynopses.put(j, getSynopsis(synopsisType));
                        }
                    ...
                    for (int i = 0; i < 10; i++) {
                        ...
                        while (reader.ready() && (line = reader.readLine()) != null) {
                            ...
                            String[] tokens = line.split(",");
                            if (synopsisType.equals("EquiWidthHistogram")) {
