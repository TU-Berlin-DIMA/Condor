...
public class SketchBloomFilterSC {
    public static void run(String outputDir, String uniformTimestampedFilePath) throws Exception {
        ...
        try {
            ...
            PrintWriter out = new PrintWriter(new FileOutputStream(new File(outputDir + "/blooom-filter-single-core.txt"), true), true);
            String line;
            String result = "Throughput=";
            String numRecords = "";
            BloomFilter synopsis = new BloomFilter(1000, 64, 42l);
            ...
            out.append("\nSource: Uniform, BloomFilter Synopsis: ");
            out.append("\n" + result);
