...
//		env.setMaxParallelism(1);
		...
		SingleOutputStreamOperator<ReservoirSampler> synopsesStream = BuildSynopsisOld.timeBased(timestamped, Time.milliseconds(10000),10, synopsisClass, new Object[]{10000});
