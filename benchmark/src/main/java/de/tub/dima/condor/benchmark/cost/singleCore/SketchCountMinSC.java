...
public class SketchCountMinSC {
    public static void run(String outputDir, String uniformTimestampedPath) throws Exception {
        ...
        try {
            ...
            PrintWriter out = new PrintWriter(new FileOutputStream(new File(outputDir + "/countMin-sketchsingle-core.txt"), true), true);
            String line;
            ...
            out.append("\nSource: Uniform, CountMinSketch Synopsis: ");
            out.append("\n" + result);
