package de.tub.dima.condor.flinkScottyConnector.evaluator;
...
import de.tub.dima.condor.flinkScottyConnector.evaluator.evaluation.QueryLatestFunction;
import de.tub.dima.condor.flinkScottyConnector.evaluator.evaluation.QueryLatestStratifiedFunction;
import de.tub.dima.condor.flinkScottyConnector.evaluator.evaluation.QueryStratifiedTimestampedFunction;
import de.tub.dima.condor.flinkScottyConnector.evaluator.evaluation.QueryTimestampedFunction;
...
public final class ApproximateDataAnalytics {
    ...
    public static <Q extends Serializable, S extends Synopsis, O extends Serializable> SingleOutputStreamOperator<QueryResult<Q, O>> queryLatest
        ...
        return queryStream.connect(broadcast)
                .process(new QueryLatestFunction(queryFunction));
    }
    ...
    public static <P extends Serializable, Q extends Serializable, S extends Synopsis, O extends Serializable> SingleOutputStreamOperator<StratifiedQueryResult<Q, O, P>> queryLatestStratified
        ...
        return keyedQueryStream.connect(broadcast)
                .process(new QueryLatestStratifiedFunction(queryFunction, partitionClass, synopsisMapStateDescriptor));
    }
