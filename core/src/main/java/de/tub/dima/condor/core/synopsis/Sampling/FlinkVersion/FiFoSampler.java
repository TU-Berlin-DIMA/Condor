package de.tub.dima.condor.core.synopsis.Sampling.FlinkVersion;
...
public class FiFoSampler<T> implements MergeableSynopsis<T>, Serializable {
     ...
     * the {@code FlinkScottyConnector.BuildSynopsis} retaining only the newest elements that entered the window.
     *
